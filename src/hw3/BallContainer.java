...
public class BallContainer implements Iterable<Ball> {
    ...
    public boolean add(Ball b) {
        // Returns false, if ball is already in the container
    	if (contains(b)) {
    		return false;
    	}
    	
    	//true if ball was successfully added to the container
    	contents.add(b);
    ...
    public boolean remove(Ball b) {
        // Returns false, if ball is not in the container.
        if (!contains(b)) {
        	return false;
        }
        
        // true if ball was successfully removed from the container
        contents.remove(b);
        totalVolume -= b.getVolume();
        return true;
    }
    ...
    public double getVolume() {
        // total volume of all the Balls in the container
    ...
    public boolean contains(Ball b) {
        // true if this container contains the specified Ball.
